...
print(f"- Total Yards Sold: {total_yards_sold:,.0f} yards")
print(f"- Average Price per Yard: ${avg_price_per_yard:.2f}")
print(f"- Number of Transactions: {num_transactions:,}")
print(f"- Unique Customers: {num_unique_customers}")
print(f"- Unique Styles: {num_unique_styles}")
...
print(f"\nInventory Summary:")
print(f"- Total Inventory: {total_inventory_yards:,.0f} yards")
print(f"- Total Weight: {total_inventory_pounds:,.0f} lbs")
print(f"- Number of Styles in Stock: {num_styles_in_inventory}")
...
print(f"- Total Yards on Order: {total_orders_yards:,.0f} yards")
print(f"- Number of Open Orders: {num_open_orders}")
...
print(f"- Styles in sales history: {len(sales_styles)}")
print(f"- Styles in current orders: {len(order_styles)}")
print(f"- Styles in inventory: {len(inventory_styles)}")
print(f"- Styles in both sales and orders: {len(common_sales_orders)}")
print(f"- Styles in both sales and inventory: {len(common_sales_inventory)}")

# Demand vs Supply Analysis for common styles
print("\nDemand vs Supply Analysis (Top 20 styles by sales):")
print("Style | Historical Sales (yds) | Current Inventory (yds) | Pending Orders (yds)")
print("-" * 80)
...
for style in top_selling_styles.index:
    ...
    print(f"{style:<15} | {historical_sales:>20,.0f} | {current_inventory:>22,.0f} | {pending_orders:>18,.0f}")
...
print("Style | Avg Monthly Demand | Current Inventory | Coverage (months)")
print("-" * 70)
...
for alert in alerts[:10]:  # Show top 10 alerts
    print(f"{alert['style']:<15} | {alert['monthly_demand']:>17,.0f} | {alert['inventory']:>16,.0f} | {alert['coverage']:>16.1f}")
...
print("\nReports saved:")
print("- sales_inventory_summary.json")
print("- inventory_alerts.csv")
